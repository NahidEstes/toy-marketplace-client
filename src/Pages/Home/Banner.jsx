      ...
      <div className="container relative flex flex-col items-center justify-between px-6 py-8 mx-auto">
        <div className="flex flex-col">
          ...
          <div className="flex items-center justify-center mt-4">
            <p
              className="px-4 py-2 mr-4 text-white uppercase bg-gray-800 border-2 cursor-pointer border-transparent text-md hover:bg-gray-900"
              data-aos="fade-right"
            >
              Get started
            </p>
            <p
              className="px-4 py-2 text-gray-800 uppercase bg-transparent border-2 cursor-pointer border-gray-800  hover:bg-gray-800 hover:text-white text-md"
              data-aos="fade-left"
            >
              Learn More
            </p>
        ...
        <div
          className="relative block w-full mx-auto lg:mt-4 mt-6 md:mt-4"
          data-aos="fade-right"
        >
          <img
